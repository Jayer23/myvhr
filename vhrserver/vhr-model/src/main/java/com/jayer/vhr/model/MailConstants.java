...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "jayer.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "jayer.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "jayer.mail.routing.key";
}
